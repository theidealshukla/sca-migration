export const metadata = {
  ...
  description: 'Indore\'s leading solar EPC company. Residential 3-10kW, commercial and industrial rooftop solar with PM Surya Ghar subsidy support across Madhya Pradesh.',
  alternates: { canonical: 'https://scatechsolar.com' },
  openGraph: {
    title: 'SCA Tech Solar | #1 Solar Panel Installation in Indore',
    description: 'Premium rooftop solar for homes and businesses in MP.',
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "FAQPage",
          "mainEntity": [
            {"@type": "Question", "name": "How much does a solar installation cost in Indore?", "acceptedAnswer": {"@type": "Answer", "text": "A typical 3 kWp residential system costs ₹1.3–1.6 lakh before subsidy. After PM Surya Ghar subsidy of ₹78,000, net cost is ₹55,000–80,000. Commercial and industrial pricing is calculated per watt peak (₹45–55/Wp)."}},
            {"@type": "Question", "name": "What is the payback period for solar in Indore?", "acceptedAnswer": {"@type": "Answer", "text": "With Indore's 300+ sunny days and MPEZ tariff of ₹7.5–9/unit, payback periods are typically 3–5 years for residential and 2.5–4 years for commercial. After payback, you generate free electricity for the remaining 20+ years."}},
            ...
            {"@type": "Question", "name": "How do I apply for the PM Surya Ghar subsidy?", "acceptedAnswer": {"@type": "Answer", "text": "SCA Tech handles the entire subsidy process at no extra cost. We register you on the PM Surya Ghar portal, coordinate with MPEZ for net meter, and ensure the subsidy is credited directly to your bank account."}},
            ...
            {"@type": "Question", "name": "What maintenance is required for solar panels?", "acceptedAnswer": {"@type": "Answer", "text": "Solar panels require minimal maintenance — mainly periodic cleaning to remove dust. Indore's dusty climate means cleaning every 2–3 months. We offer Annual Maintenance Contracts starting ₹3,500/year including 2 cleanings and performance health checks."}},
