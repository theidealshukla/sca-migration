      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 auto-rows-[220px] gap-4">
          {FEATURED_PROJECTS.map((p, i) => {
            ...
            return (
              <div key={p.id} className={`relative rounded-2xl overflow-hidden group cursor-pointer border border-[#EBEBEB] shadow-sm ${spanClass}`}>
                <img
                  src={p.image_url}
                ...
                <div className="absolute inset-0 p-5 flex flex-col justify-end">
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <p className="text-xs font-bold text-white/70 tracking-wider uppercase mb-1">{p.tag}</p>
        ...
        <div className="mt-10 flex flex-wrap gap-3 justify-center">
          {['Solar EPC', 'Transmission Lines', 'Substations', 'BESS', 'Green Hydrogen', 'O&M'].map((tag, i) => (
