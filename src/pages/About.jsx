    ...
    <div className="pt-20">
      ...
      <div className="py-20 bg-solar-500">
        <div className="max-w-4xl mx-auto px-5 md:px-8 text-center">
          ...
          <Link to="/contact" aria-label="Book free solar survey in Indore" className="inline-flex items-center gap-2 bg-white text-solar-700 font-bold px-8 py-4 rounded-full hover:shadow-xl transition-all duration-300">
